      ...
      return function(err, config) {
        ...
        return fs.readdir(_this.options.directory, function(err, dirs) {
          ...
          for (i = 0, len = dirs.length; i < len; i++) {
            ...
            repos[dir] = {
              name: dir,
              port: (ref = config[dir]) != null ? ref.port : void 0
            };
          }
    ...
    return fs.readFile(this.options.directory + "/config.json", 'utf8', (function(_this) {
      return function(err, config) {
        ...
        if (repo.port == null) {
          ...
          changed = true;
        } else if (((ref = config[repo.name]) != null ? ref.port : void 0) !== (repo.port != null)) {
          if (config[name1 = repo.name] == null) {
            config[name1] = {};
          }
