...
var arg, argTab, buildAssetsFiles, config, count, del, dirpath, dockerExec, dockerRun, e, each, exec, fs, http, i, ini, list, multimatch, parameters, params, path, rm, setPort, start, stop, sync, syncRepo, url, util, _i, _len,
...
dockerExec = function(action, repo, callback) {
  return exec("docker " + action + " repo_" + arg, callback);
};
